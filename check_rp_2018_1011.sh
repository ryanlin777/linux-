...
echo -e "\033[36m使用中SSL證書\033[0m"| tee -a /home/check_rp.txt ; cat /opt/APP/openresty/nginx/conf/vhost/*conf | grep ssl_certificate | tee -a /home/check_rp.txt
echo -e "\033[36mSSL證書檔案\033[0m"| tee -a /home/check_rp.txt ; ls -lrt /opt/APP/openresty/nginx/conf/ssl | tee -a /home/check_rp.txt
